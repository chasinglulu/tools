...
Description:
    ...
    from the flash field. It uses the argparse module to accept the YAML
...
def parse_yaml(yaml_file):
    """
    Parse the specified YAML file and extract page_size and block_size from the flash field.
    """
    try:
